    ...
    <ul className="navbar-nav">
      <li className="logo">
        <a href="#nav" className="nav-link">
          <span className="link-text logo-text">Neoo Partners</span>
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
      ...
      <Link to="/" className="nav-item">
        ...
        viewBox="0 0 640 512">
            ...
            className="fa-secondary"
            ></path></svg>
          <span className="link-text">Diagrams</span>
        </a>
      </Link>
      ...
      <li className="nav-item" onClick={this.projects}>
        <a href="#nav" className="nav-link">
        <svg aria-hidden="true" 
        focusable="false" 
        data-prefix="fas" 
      ...
      <li className="nav-item final">
        <img src="/NEOO Partners Logo.png" width="200px" alt="Neoo"/>
      </li>
    </ul>
  </nav>
        )
